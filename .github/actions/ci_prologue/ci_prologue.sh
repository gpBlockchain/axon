...
fun_pasing_message(){
  ...
  if [ $? -eq 0 ]; then
    ...
    job_run_list=" [ Chaos CI,Cargo Clippy,Coverage Test,E2E Tests,Conventional PR,Unit Tests,Web3 Compatible Tests,Openzeppelin Contracts Tests 1-5 And 12-15,Openzeppelin Contracts Tests 6-10,Openzeppelin Contracts Tests 11,Openzeppelin Contracts Tests 16-19] "
  fi
